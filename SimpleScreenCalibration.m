...
%screen name
screenName = 'TSavage_Office_asus';
...
%linearity (measure  = 0)
lookupTableFile = 'BMIC_Scanner_Projector_Calibration_InControlRoom_17March2017.mat';
...
if ~measure
    calDataFile = [calDataFile '_LinearityCheck.mat'];
else
    calDataFile = [calDataFile '.mat'];
    lookupTableFile = '';
end
