function [dotRect,dotTexture]=Complex2RealBlur(display, dots, csf, blur)
...
%     dotImgFinal=uint8(cat(3,dotImgFilt,dotImgFilt,dotImgFilt,dotImgFilt)*255);
    dotImgFinal=uint8(cat(3,zed,zed,zed,dotImgFilt2)*255);
else
    ...
    dotImgFinal=double(cat(3,dotImg,dotImg,dotImg,dotImg))*255;
