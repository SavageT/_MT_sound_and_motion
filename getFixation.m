function   display = getFixation(display)
...
% sz(1)=round((sz(1)-2)/2)*2+2; %make them all even
% sz(2)=round((sz(2)-2)/2)*2+2;
% sz(3)=round((sz(3)-2)/2)*2+2;
...
display.fixation.sz=sz;
display.fixation.center=center;
end
